        ...
        if (typeof kill === 'object' && typeof env === 'object') {
            ...
            if (!isOwner) {
                ...
                if (
                    ...
                    envInfo.results.value = await kill.sendMessage(chatId, { text: language(region, 'Cases', 'Stranded', true, true, envInfo) }, { quoted: quoteThis });
                    ...
                    for (let i = 0; i < mentionPeople.length; i += 1) {
                        /* Adiciona os valores */
                        Indexer('sql').update('leveling', mentionPeople[i], chatId, false, newValues);
                    }
