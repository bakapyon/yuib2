    ...
    try {
        ...
        if (typeof kill === 'object' && typeof env === 'object') {
            ...
            if (arks.includes('--help-dev') && isOwner === true) {
                ...
                await kill.sendMessage(chatId, { text: language(region, 'Extras', 'Wait', true, true, envInfo) }, { quoted: quoteThis });
            ...
            if (stickerData !== false) {
                ...
                /* Faz o envio */
                envInfo.results.value = await kill.sendMessage(chatId, stickerData, {
                    quoted: quoteThis,
                });
                ...
                envInfo.results.value = await kill.sendMessage(chatId, { text: language(region, 'Loggers', 'Error', true, true, envInfo) }, { quoted: quoteThis });
            }
        }
