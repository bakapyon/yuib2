...
Este guia irá ajudá-lo a instalar a Yui no Linux usando um script e executando comandos específicos.
...
3. [⚙️ Instalando a Yui](#%EF%B8%8F-instalando-a-Yui)
...
Antes de iniciar a instalação da Yui no Linux, certifique-se de atender aos seguintes Pré-Requisitos:
...
Uma vez que você tenha instalado todos os requisitos, abra um terminal e digite `cd`, depois copie e cole os seguintes comandos para instalar os requisitos do ambiente da Yui, você pode copiar e colar o texto inteiro abaixo se preferir.
...
### 🌟 Método Nº5 - Usando o Editor Oficial da Yui
