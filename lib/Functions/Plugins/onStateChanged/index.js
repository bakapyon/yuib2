    ...
    try {
        ...
        if (typeof newState === 'object') {
            ...
            if (newState.connection === 'close') {
                ...
                console.log(Indexer('color').echo(`[${(DisconnectReason[lastReason] || 'UNKNOWN').toUpperCase()}]`, 'red').value, Indexer('color').echo(language(region, 'States', `${lastReason}`, true, true), 'green').value);
                ...
                console.log(Indexer('color').echo(`[${(newState.connection || 'UNKNOWN').toUpperCase()}]`, 'red').value, Indexer('color').echo(language(region, 'States', newState.connection, true, true), 'green').value);
            }
        }
